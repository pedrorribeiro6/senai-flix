...
background-image: linear-gradient(90deg, #650798, #1308ea);
color: #fff;
text-align: center;
padding: 80px 0;
`
...
return (
<PesquisaContainer>
<Titulo>Qual filme você gostaria assistir?</Titulo>
<Subtitulo>Busque os filmes disponíveis no catálogo.</Subtitulo>
<Input
